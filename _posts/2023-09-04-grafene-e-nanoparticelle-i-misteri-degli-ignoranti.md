---
layout: post
title: "Grafene e nanoparticelle, i misteri degli ignoranti"
...
In principio c'era solo la scia chimica, poi arrivò a darle manforte il grafene. 
    ...
    Quella dei Black-Eyed Children è una vecchia leggenda metropolitana americana, basta andare a cercare in rete e si trova un universo di teorie fantasiose, a patto che si capisca minimamente la lingua inglese...

    Va da se anche che i collegamenti con la rete 5G sono privi di fondamento non trovando alcun criterio scientifico applicabile.

    Insomma la narrazione che circola attraverso un breve filmato e ad un post di un sito complottista dedicato a Brunet è destituita di ogni fondamento scientifico. Quando raccomandavo la comprensione dell'inglese, non lo facevo a caso, infatti nel post si legge "grafene inoculato conduttore rete 5G", forse frutto di una traduzione non ben fatta per la lingua originale non ben compresa.  Nel prosieguo del post si legge poi che "Dott.ssa Viviane Brunet: Sì. Sì, è allora che abbiamo una coppia che era stata inoculata prima dell’unione dell’ovulo e dello sperma. Quando hanno sparato. È mutageno. Produce mutazioni nel genoma umano. E’ un mutageno. Quando quelle persone — quella coppia già vaccinata — hanno il concepimento di un nuovo essere, è quando nascono bambini transumani con caratteristiche diverse dal normale essere umano".
